...
if(isset($_SESSION['sesion_email'])){
  //echo"el usuario paso porel login";
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=APP_URL;?>/admin" class="brand-link">
      <img src="<?=APP_URL;?>/public/img/SM.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SAN MARCOS</span>
    </a>
