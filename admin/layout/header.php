<?php
  ...
  if( isset($_SESSION['email']) ){
    ...
    foreach( $datos_session_usuarios as $usuario ){
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= APP_URL ?>/admin" class="brand-link">
      <img src="https://cdn-icons-png.flaticon.com/512/8555/8555318.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu">
            <a href="#" class="nav-link active">
              <i class="nav-icon fas"><i class="bi bi-person-badge-fill"></i></i>
              <p>
                Roles
          ...
          <li class="nav-item">
            <a href="<?=APP_URL?>/login/logout.php" class="nav-link" style="background-color:red; color:white;">
              <i class="nav-icon fas"><i class="bi bi-box-arrow-in-left"></i></i>
              <p>
                Cerrar Session
              </p>
            </a>
